      ...
      if (request == null) {
        ...
        if (request.length() == 0) {
          ...
          try {
            ...
            builder.append("Content-Type: text/html; charset=utf-8\n");
            builder.append("\n");
            builder.append("Error: Invalid input for multiplication. Please provide integers for num1 and num2.");
        }
          ...
          //     "/repos/OWNERNAME/REPONAME/contributors"
           ...
           System.out.println("GitHub API response: " + json);
           ...
           try {
             ...
             for (int i = 0; i < repos.length(); i++) {
               ...
               builder.append("{");
               builder.append("\"full_name\":\"").append(repo.getString("full_name")).append("\",");
               builder.append("\"id\":\"").append(repo.getInt("id")).append("\",");
               builder.append("\"owner_login\":\"").append(repo.getJSONObject("owner").getString("login")).append("\"");
               builder.append("}");
               if (i < repos.length() - 1) builder.append(",");
             }
             builder.append("]");
          ...
          // Adding Custom Endpoint 1: /concatenate?str1=hello&str2=world
          ...
          try {
            ...
            builder.append("Content-Type: text/html; charset=utf-8\n");
            builder.append("\n");
            builder.append("Error: Please provide both str1 and str2 parameters for concatenation.");
          }
        }

        // Adding Custom Endpoint 2: /power?base=2&exponent=3
          ...
          try {
            ...
            Integer exponent = Integer.parseInt(query_pairs.get("exponent"));
            Integer result = (int) Math.pow(base, exponent);

            builder.append("HTTP/1.1 200 OK\n");
            builder.append("Content-Type: text/html; charset=utf-8\n");
            builder.append("\n");
            builder.append("Power result: " + result);
          } catch (NumberFormatException | NullPointerException e) {
            builder.append("HTTP/1.1 400 Bad Request\n");
            builder.append("Content-Type: text/html; charset=utf-8\n");
            builder.append("\n");
            builder.append("Error: Invalid input. Please provide integer values for base and exponent.");
          } 
